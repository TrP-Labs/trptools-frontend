...
const API_ERRORS: Record<string, () => string> = {
	...
	'no Discord account is linked': m.api_error_no_discord_account_is_linked,
	...
	'sign-up sheet does not exist': m.api_error_sign_up_sheet_does_not_exist,
	...
	'that slot is on a different shift': m.api_error_that_slot_is_on_a_different_shift,
	...
	'this group asks applicants to link a Discord account first': m.api_error_this_group_asks_applicants_to_link_a,
	'this group asks you to link a Discord account before signing up': m.api_error_this_group_asks_you_to_link_a,
